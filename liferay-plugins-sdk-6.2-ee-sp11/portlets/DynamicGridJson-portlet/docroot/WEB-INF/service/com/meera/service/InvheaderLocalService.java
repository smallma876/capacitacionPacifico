...
/**
 * Provides the local service interface for Invheader. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author meera
 * @see InvheaderLocalServiceUtil
...
public interface InvheaderLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InvheaderLocalServiceUtil} to access the invheader local service. Add custom service methods to {@link com.meera.service.impl.InvheaderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
